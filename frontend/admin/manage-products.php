        ...
        <main class="flex-1 p-6">
            ...
            <div class="bg-white p-6 rounded-lg multi-shadow">
                <table class="w-full" id="products-table">
                    <thead>
                        <tr class="border-b">
                            <th class="text-left p-3 font-semibold text-gray-600">Product Name</th>
    ...
    <div id="product-modal" class="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex items-center justify-center hidden">
        <div class="bg-white p-8 rounded-lg multi-shadow w-full max-w-md">
            ...
            <form id="product-form">
                ...
                <div class="mb-4">
                    <label for="product-name" class="block text-sm font-medium text-gray-600">Product Name</label>
                    <input type="text" id="product-name" name="product-name" class="form-input mt-1 block w-full" required>
                </div>
                 <div class="mb-4">
                    <label for="product-description" class="block text-sm font-medium text-gray-600">Description</label>
                ...
                <div class="grid grid-cols-2 gap-4 mb-6">
                    <div>
                        <label for="product-price" class="block text-sm font-medium text-gray-600">Price</label>
                        <input type="number" id="product-price" name="product-price" class="form-input mt-1 block w-full" step="0.01" required>
                    </div>
                    <div>
                        <label for="product-stock" class="block text-sm font-medium text-gray-600">Stock</label>
