...
<div class="flex-1 flex flex-col">
    ...
    <main class="flex-1 p-6 bg-gray-100">
        <div class="mb-6">
            ...
            <p class="text-gray-500">Create and manage sales manager accounts, assign territories, and review performance metrics.</p>
        </div>

        <div class="bg-white p-6 rounded-lg multi-shadow">
            <div class="flex justify-between items-center mb-4">
                <h3 class="text-lg font-medium">All Sales Managers</h3>
