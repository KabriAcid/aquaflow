...
<aside class="w-64 bg-gray-800 text-white min-h-screen p-4 flex flex-col">
    ...
    <nav class="flex-1">
        <ul class="space-y-2">
            <li>
                <a href="dashboard.php" class="flex items-center gap-3 px-3 py-2 rounded-md hover:bg-gray-700 transition-colors">
            ...
            <li>
                <a href="manage-sales-managers.php" class="flex items-center gap-3 px-3 py-2 rounded-md hover:bg-gray-700 transition-colors">
                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
