document.addEventListener("DOMContentLoaded", () => {
  ...
  const btnSpinner = generateReportBtn
    ? generateReportBtn.querySelector(".spinner-border")
    : null;
    ...
    reportContent.innerHTML = `
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text"><strong>Total Revenue:</strong> $${data.total_revenue.toFixed(
                      2
                    )}</p>
